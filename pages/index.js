export default function Home() {
  return (
    <main className="container mx-auto mt-5 rounded-lg bg-gray-300 p-5">
      <div className="display grid h-[720px] p-3 sm:h-96 sm:grid-cols-2">
        <div className="mb-2 mr-2 rounded-md bg-[url('/src/01.webp')] bg-cover bg-center sm:row-start-1 sm:row-end-3"></div>
